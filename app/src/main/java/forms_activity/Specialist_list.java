...
public class Specialist_list extends AppCompatActivity{
    ...
    private List<Specialist_DataModel> dataList = new ArrayList<>();

    private RecyclerView recyclerView;
    private Specialist_list.DataAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            setContentView(R.layout.specialist_list);
            ...
            cmdBack.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    AlertDialog.Builder adb = new AlertDialog.Builder(Specialist_list.this);
                    adb.setTitle("Close");
            ...
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    IDbundle.putString("SpecialistID", "");
            ...
            recyclerView.addItemDecoration(new Specialist_list.DividerItemDecoration(this, LinearLayoutManager.VERTICAL));
        ...
        {
            Connection.MessageBox(Specialist_list.this, e.getMessage());
            return;
        }
    ...
    private void DataSearch(String SearchText)
    {
        try
        {
            ...
            try {
                lblHeading.setText("মোট : ( "+ dataList.size() +" )");
                mAdapter.notifyDataSetChanged();
            }catch ( Exception ex){
                Connection.MessageBox(Specialist_list.this,ex.getMessage());
            }
        }
        catch(Exception  e)
        {
    ...
    public class DataAdapter extends RecyclerView.Adapter<Specialist_list.DataAdapter.MyViewHolder> {
        private List<Specialist_DataModel> dataList;
        public class MyViewHolder extends RecyclerView.ViewHolder {
            LinearLayout secListRow;
            TextView SpecialistID;
            TextView reg_date;
            TextView name;
            ...
            public MyViewHolder(View convertView) {
                ...
                SpecialistID = (TextView)convertView.findViewById(R.id.SpecialistID);
                reg_date = (TextView)convertView.findViewById(R.id.reg_date);
                name = (TextView)convertView.findViewById(R.id.name);
                mobile = (TextView)convertView.findViewById(R.id.mobile);
            }
        }
        public DataAdapter(List<Specialist_DataModel> datalist) {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new Specialist_list.DataAdapter.MyViewHolder(itemView);
        }
        @Override
        public void onBindViewHolder(Specialist_list.DataAdapter.MyViewHolder holder, int position) {
            final Specialist_DataModel data = dataList.get(position);
            holder.SpecialistID.setText(data.getSpecialistID());
            holder.reg_date.setText(Global.DateConvertDMY(data.getreg_date()));

            holder.name.setText(data.getName());

            holder.mobile.setText(data.getContactNumber());

            holder.secListRow.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    final ProgressDialog progDailog = ProgressDialog.show(Specialist_list.this, "", "Please Wait . . .", true);
                    new Thread() {
                        public void run() {
                            try {
                                Bundle IDbundle = new Bundle();
                                IDbundle.putString("SpecialistID", data.getSpecialistID());
